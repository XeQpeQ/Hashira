...
function Library:Create(table)
    ...
    function ElementHandler:Dropdown(text, options, callback)
        ...
        dropdownButton.TextColor3 = Color3.fromRGB(195, 195, 195)
        dropdownButton.TextSize = 13
        dropdownButton.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
        dropdownButton.Position = UDim2.fromScale(0.864, 0.188)
        dropdownButton.Size = UDim2.fromOffset(52, 19)
    
        local uICorner16 = Instance.new("UICorner")
        uICorner16.Name = "uICorner16"
        uICorner16.CornerRadius = UDim.new(0, 6)
        uICorner16.Parent = dropdownButton
        ...
        dropdownFrame.Position = UDim2.fromOffset(0, 32)
        dropdownFrame.Size = UDim2.fromOffset(441, 0)
        ...
        uICorner17.Parent = dropdownFrame
    
        local uIListLayout2 = Instance.new("UIListLayout")
        uIListLayout2.Name = "uIListLayout2"
        uIListLayout2.Padding = UDim.new(0, 3)
        uIListLayout2.SortOrder = Enum.SortOrder.LayoutOrder
        uIListLayout2.Parent = dropdownFrame
        ...
        for index, optionText in ipairs(options) do
            ...
            optionButton.TextColor3 = Color3.fromRGB(195, 195, 195)
            ...
            optionButton.MouseEnter:Connect(function()
                game:GetService('TweenService'):Create(optionButton, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(43,43,43)}):Play()
            end)
    
            optionButton.MouseLeave:Connect(function()
                game:GetService('TweenService'):Create(optionButton, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(38,38,38)}):Play()
            end)
        ...
        dropdownFrame.Size = UDim2.new(0, dropdownButton.AbsoluteSize.X, 0, 32 * #options)
